...
command -v virtualenv >/dev/null 2>&1 || { echo "Cannot find virtualenv. You may need to install it by following the documentation at shttps://dcos.io/docs/usage/cli/install/. Aborting."; exit 1; }
