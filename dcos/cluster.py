...
def setup_cluster_config(dcos_url, real_path, temp_cluster_path, stored_cert):
    """
    ...
    :type real_path: str
    :param temp_cluster_path: path to the temp cluster dir
    :type temp_cluster_path: str
    ...
    util.sh_move(temp_cluster_path, cluster_path)
