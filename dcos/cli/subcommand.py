...
def _default_modules():
    ...
    from dcos.cli.auth import main as auth_main
    from dcos.cli.cluster import main as cluster_main
    from dcos.cli.config import main as config_main
    from dcos.cli.experimental import main as experimental_main
    from dcos.cli.help import main as help_main
    from dcos.cli.job import main as job_main
    from dcos.cli.marathon import main as marathon_main
    from dcos.cli.node import main as node_main
    from dcos.cli.package import main as package_main
    from dcos.cli.service import main as service_main
    from dcos.cli.task import main as task_main
...
def default_doc(command):
    ...
    resource = "cli/data/help/{}.txt".format(command)
