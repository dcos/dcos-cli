...
from dcos.cli.auth.main import login
from dcos.cli.subcommand import default_command_info, default_doc
from dcos.cli.tables import clusters_table
from dcos.cli.util import confirm, decorate_docopt_usage
...
def _main(argv):
    args = docopt.docopt(
        default_doc("cluster"),
        argv=argv,
        version='dcos-cluster version {}'.format(dcos.cli.version))
