...
GOOD_GROUP = _DATA_DIR + 'marathon/groups/good.json'
SCALE_GROUP = _DATA_DIR + 'marathon/groups/scale.json'
...
def test_validate_complicated_group_and_app():
    with group(_DATA_DIR + 'marathon/groups/complicated.json',
               'test-group'):
        pass
...
def test_add_bad_complicated_group():
    with open(_DATA_DIR + 'marathon/groups/complicated_bad.json') as fd:
...
def test_update_group_from_stdin():
    with group(GOOD_GROUP, 'test-group'):
        _update_group(
            'test-group',
            _DATA_DIR + 'marathon/groups/update_good.json')
