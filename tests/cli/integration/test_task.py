...
SLEEP_COMPLETED = 'tests/cli/data/marathon/apps/sleep-completed.json'
SLEEP_COMPLETED1 = 'tests/cli/data/marathon/apps/sleep-completed1.json'
SLEEP1 = 'tests/cli/data/marathon/apps/sleep1.json'
SLEEP2 = 'tests/cli/data/marathon/apps/sleep2.json'
FOLLOW = 'tests/cli/data/file/follow.json'
TWO_TASKS = 'tests/cli/data/file/two_tasks.json'
TWO_TASKS_FOLLOW = 'tests/cli//data/file/two_tasks_follow.json'
LS = 'tests/cli/data/tasks/ls-app.json'
...
def test_log_pod_task():
    good_pod_file = 'tests/cli/data/marathon/pods/good.json'
...
def test_exec_non_interactive():
    with open('tests/cli/data/tasks/lorem-ipsum.txt') as text:
        content = text.read()
