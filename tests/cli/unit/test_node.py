...
import dcos.cli.node.main as main
...
@mock.patch('dcos.packagemanager.PackageManager')
@mock.patch('dcos.http.get')
@mock.patch('dcos.cli.node.main._do_diagnostics_request')
...
@mock.patch('dcos.packagemanager.PackageManager')
@mock.patch('dcos.cli.node.main._do_request')
@mock.patch('dcos.cli.node.main._get_bundle_list')
...
@mock.patch('dcos.http.get')
@mock.patch('dcos.cli.log.dcos_log_enabled')
...
@mock.patch('dcos.cli.log.follow_logs')
@mock.patch('dcos.config.get_config_val')
@mock.patch('dcos.http.get')
@mock.patch('dcos.cli.log.dcos_log_enabled')
...
@mock.patch('dcos.config.get_config_val')
@mock.patch('dcos.cli.node.main._get_slave_ip')
@mock.patch('dcos.http.get')
